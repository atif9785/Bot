...
AtifAslam4You
Idline: http://line.me/ti/p/L9z8AFrzKE""",
    "lang":"En",
			...
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
                ...
                msg.contentMetadata = {
                                     ...
                                     "STKVER": "100" }
                ki.sendMessage(msg)
            elif msg.text in ["Assalamoalaikom","Asslamoalaikom","asslamoalaikom","Assalamualaikom","AssalamoAlaikom"]:
            	msg.contentType = 7
                msg.text = ("Walaikom Asslam Warehmatullahi Wabarakatuhu")
                ki.sendMessage(msg)
                kk.sendMessage(msg)
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||ap hi dekh lo kon h dekho ye||%s\n||By : Koplaxs BOT||\n\n>Pelaku CCTV<\n%s-=CCTV=-\n•Bintitan\n•Panuan\n•Kurapan\n•Kudisan\n\n Abe readers Bahar niklo\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            ...
            elif msg.text in ["Kuya","Kunyuk","Bb"]:
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye op","Kabur all","Kaboor all","Out"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
        ...
        #----------------Fungsi Kick User Target Finish----------------------#      
            ...
            #----------------Fungsi Banned User Target Start-----------------------#
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    print "[Banned] Sukses"
                    _name = msg.text.replace("Banned @","Ban @")
                    _nametarget = _name.rstrip('  ')
                    gs = cl.getGroup(msg.to)
                    gs = ki.getGroup(msg.to)
                    gs = kk.getGroup(msg.to)
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                ke.sendText(msg.to,"💪💪💪💪💪💪💪💪💪")
                ku.sendText(msg.to,"💪💪💪💪💪💪💪💪💪💪")
                cl.sendText(msg.to,"Protect he re baba")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Apka Apna Atif😜")
                
      #-------------Fungsi Chat ----------------
            elif msg.text in ["Woy","woy","Woi","woi","bot","Bot"]:
                 quote = ['Ufff Bot nhi BodyGourd💪👈']
