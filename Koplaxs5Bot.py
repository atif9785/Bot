...
Owner : ✰Atif✰
-==================-
◄]·♦·Public ke liye commond·♦·[►
[•]Adminlist
[•]Info Group
[•]Welcome
[•]Creator
[•]Bot
◄]·♦·Admin ke liye commond·♦·[►
-==================-
[•]Cancel
[•]「Buka/Tutup」qr
[•]Mid Bot
...
admin=["u1cdd8eb61e648e549133d04ff551e1bb","ue1abcd4164019c8fb3cf6a8b318be7f8"] 
owner=["u1cdd8eb61e648e549133d04ff551e1bb","ue1abcd4164019c8fb3cf6a8b318be7f8"]
whitelist=[""]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""Atif team bot
≫ Add me pm to Bot Protect ≪
...
Minat? Silahkan PM!
Idline: http://line.me/ti/p/~atif9785""",
    "lang":"JP",
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"Good Night Atif ki taraf se.")
            elif ("Luffy gn ","Gn" in msg.text):
              if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
              ...
              if msg.from_ in owner:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"Ho Gaya Add Happy")
                        except:
                            pass
                print "[Command]Staff remove executed"
              else:
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Atif Owner Yang bisa Gunain Perintah ini.")
                
            elif msg.text in ["Adminlist","adminlist"]:
              if admin == []:
                  cl.sendText(msg.to,"The stafflist is empty")
              else:
                  cl.sendText(msg.to,"Abe Ruk be.....")
                  mc = "||Admin Atif Team Bot||\n=====================\n"
                  for mi_d in admin:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||Orree ye kia kar rahe read bas||%s\n||By : Atif BOT||\n\n>Pelaku CCTV<\n%s-=CCTV=-\n•Bintitan\n•Panuan\n•Kurapan\n•Kudisan\n\n Ya Allah\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","One piece","Join kuy","In","in"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye op","Kabur all","Kaboor all","bye bot","out","Out"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#-----------------------------------------------
            ...
            elif msg.text in ["Cv say bobo ah","Bobo dulu ah","Allha Hafiz"]:
...
#-----------------------------------------------
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
              ...
              if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "khalu palak...")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'ue1abcd4164019c8fb3cf6a8b318be7f8'}
              cl.sendText(msg.to,"😍😍😍😍😍😍😍😍😍")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"😘😘😘😘😘😘😘😘😘")
      ...
      #-------------Fungsi Chat ----------------
                 ...
                 quote = ['Chup Bot nhi bol be kamina']
...
#---------------------
        if op.type == 17:
          ...
          random.choice(KAC).sendText(op.param1, "Grup ka name  "  + str(ginfo.name))
          random.choice(KAC).sendText(op.param1, "Is Grup ka Malik Hai ye "   + ginfo.creator.displayName)
          random.choice(KAC).sendText(op.param1,"Admin ke siva koi add na kar sakta kr remove bhi😊\nSemoga Betah Kk 😘")
          print "MEMBER HAS JOIN THE GROUP"
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "Gaya re ek member or Gaya ")
